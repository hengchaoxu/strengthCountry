...
public class VolunteerService {
     ...
     * @return
     */
    public List<VolunteerEntity> queryVolunteerList(VolunteerEntity volunteerEntity) {
        List<VolunteerEntity> resultList = volunteerEntityMapper.queryVolunteerList(volunteerEntity);
    ...
    public VolunteerEntity queryVolunteerEntity(VolunteerEntity volunteerEntity) {
        System.out.println(volunteerEntity);

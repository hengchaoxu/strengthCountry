...
public class BookServiceImpl implements IBookService {
	...
	@Override
	public void deleteMaterials(int quantity, String b_name) {
		bookDao.deleteMaterials(quantity,b_name);
	}

	@Override
	public List<assignment> getAssignment() {
		return bookDao.getAssignment();
	}

	@Override
	public void addMaterialsInfor(int quantity, String b_name, String childrenAccount) {
		bookDao.addMaterialsInfor(quantity,b_name,childrenAccount);
	}

	@Override
	public List<Book> getDonationBook1(String key) {
		return bookDao.getDonationBook1(key);
	}
}
